...
const baseUrl = 'https://utilitylab.dev/csv-streamliner';

const routes = {
  default: {
    title: 'Free CSV Streamliner - Clean & Optimize CSV Files Online',
    description: 'Clean, deduplicate, and transform CSV files in your browser. Remove empty rows, normalize headers, and prepare data for analytics without uploading files.',
    h1: 'Free CSV Streamliner - Clean & Optimize CSV Files Online',
    lead: 'Clean, deduplicate, and transform CSV files in your browser. Remove empty rows, normalize headers, and prepare data for analytics without uploading files.',
    schemaName: 'Csv Streamliner',
    schemaDesc: 'Clean, deduplicate, and transform CSV files in your browser. Remove empty rows, normalize headers, and prepare data for analytics without uploading files.',
    schemaUrl: baseUrl
  }
};
